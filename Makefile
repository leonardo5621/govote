...
create_user_service:
	...
	protoc --grpc-gateway_out user_service \
			--grpc-gateway_opt logtostderr=true \
			--grpc-gateway_opt paths=source_relative \
...
create_thread_service:
	protoc -I . --proto_path=protobuffers protobuffers/thread.proto --go_out=.
	protoc -I . --proto_path=protobuffers protobuffers/thread.proto --go-grpc_out=.
	protoc --grpc-gateway_out thread_service \
			--grpc-gateway_opt logtostderr=true \
			--grpc-gateway_opt paths=source_relative \
