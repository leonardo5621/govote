...
type GetThreadByFirmRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetThreadByFirmRequest) Reset() {
	*x = GetThreadByFirmRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protobuffers_thread_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetThreadByFirmRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetThreadByFirmRequest) ProtoMessage() {}

func (x *GetThreadByFirmRequest) ProtoReflect() protoreflect.Message {
	mi := &file_protobuffers_thread_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetThreadByFirmRequest.ProtoReflect.Descriptor instead.
func (*GetThreadByFirmRequest) Descriptor() ([]byte, []int) {
	return file_protobuffers_thread_proto_rawDescGZIP(), []int{11}
}

func (x *GetThreadByFirmRequest) GetFirmId() string {
	if x != nil {
		return x.FirmId
	}
	return ""
...
type GetThreadByFirmResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetThreadByFirmResponse) Reset() {
	*x = GetThreadByFirmResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protobuffers_thread_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetThreadByFirmResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetThreadByFirmResponse) ProtoMessage() {}

func (x *GetThreadByFirmResponse) ProtoReflect() protoreflect.Message {
	mi := &file_protobuffers_thread_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetThreadByFirmResponse.ProtoReflect.Descriptor instead.
func (*GetThreadByFirmResponse) Descriptor() ([]byte, []int) {
	return file_protobuffers_thread_proto_rawDescGZIP(), []int{12}
}

func (x *GetThreadByFirmResponse) GetThread() *Thread {
	if x != nil {
		return x.Thread
	}
	return nil
...
var file_protobuffers_thread_proto_rawDesc = []byte{
	...
	,
...
var file_protobuffers_thread_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_protobuffers_thread_proto_goTypes = []interface{}{
	...
	(*GetThreadByFirmRequest)(nil),    // 11: thread.GetThreadByFirmRequest
	(*GetThreadByFirmResponse)(nil),   // 12: thread.GetThreadByFirmResponse
}
var file_protobuffers_thread_proto_depIdxs = []int32{
	...
	1,  // 4: thread.GetThreadByFirmResponse.Thread:type_name -> thread.Thread
	3,  // 5: thread.ThreadService.GetThread:input_type -> thread.GetThreadRequest
	...
	3,  // 8: thread.ThreadService.GetThreadComments:input_type -> thread.GetThreadRequest
	11, // 9: thread.ThreadService.GetThreadByFirm:input_type -> thread.GetThreadByFirmRequest
	4,  // 10: thread.ThreadService.GetThread:output_type -> thread.GetThreadResponse
	6,  // 11: thread.ThreadService.CreateThread:output_type -> thread.CreateThreadResponse
	10, // 12: thread.ThreadService.CreateComment:output_type -> thread.CreateCommentResponse
	7,  // 13: thread.ThreadService.GetThreadComments:output_type -> thread.GetThreadCommentsResponse
	12, // 14: thread.ThreadService.GetThreadByFirm:output_type -> thread.GetThreadByFirmResponse
...
func file_protobuffers_thread_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protobuffers_thread_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetThreadByFirmRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_protobuffers_thread_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetThreadByFirmResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
